...
library ProductIds {
    ...
    bytes32 internal constant USDC_HUB_LENDING_V1 =
        keccak256(abi.encodePacked("USDC:HUB:lending-v1"));

    /// @dev XCM DOT liquid staking via Bifrost vDOT, v1.
    bytes32 internal constant DOT_BIFROST_VDOT_V1 =
        keccak256(abi.encodePacked("DOT:BIFROST:vdot-v1"));
}
